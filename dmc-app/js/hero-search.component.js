...
var HeroSearchComponent = (function () {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        ...
        this.heroes = this.searchTerms
            .debounceTime(300) // waits 300ms for pause in events (while typing)
            .distinctUntilChanged() // ignores if next search term is same as previous
            .switchMap(function (term) { return term // switches to new observable each time
